...
export default function BookingsFilterBar({
  ...
  const set = (partial: Partial<BookingsFilters>) => onChange({ ...filters, ...partial });
    ...
    <div className="space-y-3 mb-5">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Buscar por referência, passageiro, rota ou e-mail..."
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            Filtros
            {hasActiveFilters && (
              <span className="w-4 h-4 flex items-center justify-center rounded-full bg-teal-400 text-navy-950 text-[9px] font-bold">
                !
              </span>
            )}
          </button>
