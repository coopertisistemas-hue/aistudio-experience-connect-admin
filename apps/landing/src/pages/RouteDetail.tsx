...
import { getWhatsAppNumber, getWhatsAppMessage } from '@/lib/whatsapp';
...
export function RouteDetail() {
  ...
  const whatsappMessage = getWhatsAppMessage(tenantSettings, route.name);
